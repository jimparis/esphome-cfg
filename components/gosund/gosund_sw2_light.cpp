...
namespace esphome {
    namespace gosund_sw2 {
        ...
        void GosundSW2Output::loop() {
            // example of bringing up from 1% to maybe 20%:
            // 24 02 01 28 23
            // 24 05 01 28 23
            // 24 0A 01 28 23
            // 24 0F 01 28 23
            ...
            while (this->available()) {
                ...
                // ignore buf[3], this code originally expected 0x1E but I see 0x28
                if (buf[0] == 0x24 && buf[2] == 0x01 && buf[4] == 0x23) {
        ...
        void GosundSW2Output::dump_config() {
            ESP_LOGCONFIG(TAG, "Gosund SW2 jim");
        }
